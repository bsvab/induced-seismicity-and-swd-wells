// Create and load pore pressure layer to map3 for Layer 13
    ...
    .then(dataset => {
        ...
        function drawMapSquares(featuresByDate, selectedDate) {
            ...
            Object.keys(squareData).forEach(key => {
                ...
                let rectangle = L.rectangle(squareBounds, {color: color, weight: 0, fillOpacity: 0.5}).addTo(map3);
